...
export const Navbar: React.FC<NavProps> = ({ onNavigate, currentPage }) => {
  ...
  // Product icon URLs (matching ProductShowcase)
  const productIcons = {
  ...
  return (
    <nav className="fixed top-0 w-full h-[70px] bg-space/90 backdrop-blur-xl border-b border-white/10 z-50 px-6 lg:px-12 flex items-center justify-between transition-all duration-300">
      ...
      <div className="hidden md:flex items-center gap-8">
        ...
        <div className="relative" ref={solutionsRef}>
          <button
            ...
            className={`flex items-center gap-1 text-sm font-medium transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-blue rounded px-2 py-1 ${
              isSolutionsOpen || currentPage === 'learning-transformer' ? 'text-white' : 'text-slate-400 hover:text-white'
            }`}
          >
            Solutions
              ...
              <div className="p-2">
                ...
                >
                  ...
                  <div>
                    ...
                    <span className="text-slate-400 text-xs">See our complete ecosystem</span>
                  </div>
                </button>
                ...
                >
                  <div className="p-2 bg-[#c73e4a]/20 rounded-lg group-hover:bg-[#c73e4a] transition-colors flex items-center justify-center">
                    <img src={productIcons.learningTransformer} alt="" className="w-5 h-5 object-contain" />
                  </div>
                  <div>
                    <span className="text-white font-semibold text-sm block">Learning Transformer</span>
                    <span className="text-slate-400 text-xs">Transform LMS content automatically</span>
                  </div>
                </button>
                
                {/* Catalyst Studio - Coming Soon */}
                <div className="w-full flex items-start gap-3 p-3 rounded-lg opacity-50 cursor-not-allowed">
                  <div className="p-2 bg-slate-700/50 rounded-lg flex items-center justify-center">
                    <img src={productIcons.catalystStudio} alt="" className="w-5 h-5 object-contain opacity-50" />
                  </div>
                  <div>
                ...
                {/* Catalyst Architect - Coming Soon */}
                <div className="w-full flex items-start gap-3 p-3 rounded-lg opacity-50 cursor-not-allowed">
                  <div className="p-2 bg-slate-700/50 rounded-lg flex items-center justify-center">
                    <img src={productIcons.catalystArchitect} alt="" className="w-5 h-5 object-contain opacity-50" />
                  </div>
                  <div>
                ...
                {/* DidactaX - Coming Soon */}
                <div className="w-full flex items-start gap-3 p-3 rounded-lg opacity-50 cursor-not-allowed">
                  <div className="p-2 bg-slate-700/50 rounded-lg flex items-center justify-center">
                    <img src={productIcons.didactaX} alt="" className="w-5 h-5 object-contain opacity-50" />
                  </div>
                  <div>
        ...
        {/* Tools Dropdown - NO ICON */}
        <div className="relative" ref={toolsRef}>
          <button
            onClick={() => setIsToolsOpen(!isToolsOpen)}
            className={`flex items-center gap-1 text-sm font-medium transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-blue rounded px-2 py-1 ${
              isToolsOpen || currentPage === 'audit' ? 'text-white' : 'text-slate-400 hover:text-white'
            }`}
          >
            Tools
          ...
          {isToolsOpen && (
            <div className="absolute top-full left-0 mt-2 w-64 bg-slate-900/95 backdrop-blur-xl border border-white/10 rounded-xl shadow-2xl overflow-hidden z-50">
              <div className="p-2">
                <button
                ...
                >
                  ...
                  <div>
                    ...
                    <span className="text-slate-400 text-xs">Calculate your ADA compliance risk</span>
                  </div>
                </button>
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <div className="text-left">
                ...
                <span className="text-slate-400 text-xs">Transform LMS content</span>
              </div>
            </button>
          </div>
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <div className="text-left">
                ...
                <span className="text-slate-400 text-xs">Calculate ADA risk</span>
              </div>
            </button>
          </div>
